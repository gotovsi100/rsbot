...
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.banking.BarbVillBank;
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.banking.BarbVillCloseBank;
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.banking.BarbVillOpenBank;
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.banking.BarbVillWalkingToBank;
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.fishing.BarbVillFishing;
import script.aiofisher.src.com.gotovsi100.tasks.barbarianvillage.fishing.WalkingToBarbVillFishArea;
...
public class AIOFisher extends PollingScript implements PaintListener,  MessageListener {
	...
	container.submit(new DraynorFishing(ctx), new DraynorBank(ctx),
			...
			, new BarbVillBank(ctx) , new BarbVillCloseBank(ctx) , new BarbVillOpenBank(ctx)
	, new BarbVillWalkingToBank(ctx) , new BarbVillFishing(ctx) , new WalkingToBarbVillFishArea(ctx) );
	}
